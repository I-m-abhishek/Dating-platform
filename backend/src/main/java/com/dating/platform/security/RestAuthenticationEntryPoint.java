...
/** 401 responses keep the same envelope as everything else. */
@Component
...
public class RestAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    public void commence(HttpServletRequest request,
        ...
        objectMapper.writeValue(response.getOutputStream(), ApiResponse.failure(
                ApiResponse.ApiError.of(ErrorCode.UNAUTHORIZED.name(),
                        ErrorCode.UNAUTHORIZED.getDefaultMessage()), null));
    }
}
